...
%       files and applies snirfAux2csv to each file found. Output CSV files
%       are saved alongside the original .snirf files.
%
%   REQUIREMENTS
%       - snirfAux2csv.m must be in MATLAB path
%       - SnirfLoad must be available (e.g., Homer3)
%
%   EXAMPLE
%       get_aux_from_snirf('C:\data\snirf_dataset')
    check_homer_path;
    % --- Input validation ---
